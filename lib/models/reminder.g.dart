...
extension ReminderQueryFilter
  ...
  QueryBuilder<Reminder, Reminder, QAfterFilterCondition> toPublishAtLessThan(
    DateTime value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Reminder, Reminder, QAfterFilterCondition> toPublishAtBetween(
    DateTime lower,
    DateTime upper, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension ReminderQuerySortBy on QueryBuilder<Reminder, Reminder, QSortBy> {
  ...
  QueryBuilder<Reminder, Reminder, QAfterSortBy> sortByToPublishAtDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'toPublishAt', Sort.desc);
    });
  }
}
...
extension ReminderQuerySortThenBy
  ...
  QueryBuilder<Reminder, Reminder, QAfterSortBy> thenByToPublishAtDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'toPublishAt', Sort.desc);
    });
  }
...
extension ReminderQueryProperty
  ...
  QueryBuilder<Reminder, DateTime, QQueryOperations> toPublishAtProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'toPublishAt');
    });
  }
}
